...
from asm.det_select_criteria import detect_unlabel_imgs
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ASM Detection with FasterRCNN on VOC2012')
    ...
    parser.add_argument('--K', default=400, type=int, help='add new unlabel samples each epoch')
